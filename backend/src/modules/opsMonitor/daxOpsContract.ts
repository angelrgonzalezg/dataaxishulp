...
export function isDaxOpsHealthReport(value: unknown): value is DaxOpsHealthReport {
  if (!value || typeof value !== 'object') return false;
  const report = value as Partial<DaxOpsHealthReport>;
  return (
    report.module === DAX_OPS_MODULE &&
    typeof report.status === 'string' &&
    typeof report.owner_app === 'string' &&
    Boolean(report.app && typeof report.app === 'object')
  );
}
